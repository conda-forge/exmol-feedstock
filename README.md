...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/exmol-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13840&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/exmol-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `exmol` can be installed with:

```
conda install exmol
```

It is possible to list all of the versions of `exmol` available on your platform with:
